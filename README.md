...
| **Tamper-Evident Audit** | `[PARTIAL]` | `/audit` maintains cryptographic SHA-256 hash chains over approval decisions; individual tool executions are not yet appended to the chain. |
